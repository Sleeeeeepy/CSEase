...
public class CommentEditService implements Service {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws ServiceException, NotFoundException {
		...
		System.out.println("포스트아이디:" + request.getParameter("commentId"));
		int id = 0;
		try {
		...
		cDao.update(new CommentBean(id, 0, 0, contents, null, ""));
	}
