	...
	<div class="row min-vh-100 justify-content-center align-items-center">
		<div class="login-form">
			<div class="card shadow card-title border-bottom card-body">
				<form method="POST" action="${pageContext.request.contextPath}/Group/Add" enctype="multipart/form-data">
					<h1 class="h3 mb-3 fw-bolder text-center">Create a group</h1>
					<br>
					<div class="mt-2">
						<input type="text" name="name" class="form-control mt-1" placeholder="Group Name" data-bs-toggle="tooltip" data-bs-placement="bottom" title="" required>
						...
						<div class="mt-1 d-grid gap-2">
							<input class="btn btn-primary" type="submit" value="Make a group!">
						</div>
					</div>
				</form>
			</div>
